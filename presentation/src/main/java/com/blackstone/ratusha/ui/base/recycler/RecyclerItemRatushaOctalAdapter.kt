...
import kotlinx.android.synthetic.main.item_order_recycler_octal.view.*
import android.text.Html
import com.blackstone.ratusha.R
import com.blackstone.ratusha.ui.screens.detailed.DetailItemInfo
import com.blackstone.ratusha.ui.widget.ExpandableCardViewYellow
 ...
 * @created 17.02.2019
 */
class RecyclerItemRatushaOctalAdapter(var itemList: MutableList<ItemOrder> = mutableListOf()) : RecyclerView.Adapter<RecyclerItemRatushaOctalAdapter.BaseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = BaseViewHolder(LayoutInflater.from(parent.context)
        .inflate(R.layout.item_order_recycler_octal, parent, false))
    ...
    inner class BaseViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private fun inflateData(itemName: String, urlImage: String, countStart: Int, countFinish: Int, price: Int) {
            val card = itemView.findViewById<ExpandableCardViewYellow>(R.id.exp_cardview)
